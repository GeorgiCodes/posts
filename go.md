...
In Go, the length of the array forms part of its type. The assignment in Listing 1.4 will throw an error:
###### Listing 1.3
```go
var elements [4]int
...
Figure 1.2 shows what the call stack looks like for this program.
